...
export default async function Home() {
  ...
  const features = [
    ...
    {
      icon: BarChart2,
      title: t('features.financialInsights.title'),
      description: t('features.financialInsights.description'),
    },
    {
      icon: Coins,
    ...
    {
      icon: Users,
      title: t('features.groupExpenses.title'),
      description: t('features.groupExpenses.description'),
    },
    {
      icon: Tags,
    ...
    {
      icon: Zap,
      title: t('features.aiDrivenInsights.title'),
      description: t('features.aiDrivenInsights.description'),
    },
  ]

  const testimonials = [
    {
      name: t('testimonials.yash.name'),
      quote: t.raw('testimonials.yash.quote'),
    },
    {
      name: t('testimonials.meet.name'),
      quote: t.raw('testimonials.meet.quote'),
    },
    {
      name: t('testimonials.akshay.name'),
      quote: t.raw('testimonials.akshay.quote'),
    },
  ]
  ...
  const faqs = [
    ...
    {
      question: t('faqs.getStarted.question'),
      answer: t('faqs.getStarted.answer'),
    },
    {
      question: t('faqs.dataSafety.question'),
      answer: t('faqs.dataSafety.answer'),
    },
    {
      question: t('faqs.isFree.question'),
      answer: t('faqs.isFree.answer'),
    },
  ]
      ...
      <MaxWidthWrapper>
        <section className="px-3 pt-24 sm:pt-28 md:px-0 lg:px-0">
          <div className="flex flex-col items-center justify-between gap-12 md:flex-row">
            <div className="w-full max-w-xl md:max-w-none md:flex-1 md:text-left">
              <h1 className="group text-5xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white sm:text-6xl md:text-6xl">
                {t('heroTitle').split('expenses').map((part, i, arr) => (
                  i === 0 ? (
                    <span key={i}>
                      {part}
                      <span className="relative inline-block transition-transform duration-300 ease-in-out group-hover:translate-y-[-2px]">
          ...
          <div className="text-center">
            ...
            <div className="mt-8 flex justify-center">
              <Link
                ...
                className="hover:bg-primary-dark group inline-flex items-center justify-center rounded-lg bg-primary px-8 py-3 text-lg font-medium text-white transition-all duration-300 ease-in-out hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
              >
                <span className="mr-2">{t('getStartedFree')}</span>
                <ArrowRight
                  className="h-5 w-5 transition-transform duration-300 ease-in-out"
                  aria-hidden="true"
                />
