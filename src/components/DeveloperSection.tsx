...
export default function DeveloperSection() {
  const t = useTranslations("HomePage.DeveloperSection")
                ...
                <div className="flex justify-center gap-4">
                  ...
                  >
                    <Link href={`mailto:${developer.email}`}>
                      <Mail className="h-4 w-4" />
                      <span className="sr-only">
                        {t("socials.email", { name: developer.name })}
                      </span>
                    </Link>
                  </Button>
                  <Button
                  ...
                  >
                    ...
                    >
                      <Linkedin className="h-4 w-4" />
                      <span className="sr-only">
                        {t("socials.linkedin", { name: developer.name })}
                      </span>
                    </Link>
                  </Button>
                  <Button
                  ...
                  >
                    ...
                    >
                      <TwitterIcon />
                      <span className="sr-only">
                        {t("socials.twitter", { name: developer.name })}
                      </span>
                    </Link>
                  </Button>
                  <Button
                  ...
                  >
                    ...
                    >
                      <Github className="h-4 w-4" />
                      <span className="sr-only">
                        {t("socials.github", { name: developer.name })}
                      </span>
                    </Link>
                  </Button>
                </div>
